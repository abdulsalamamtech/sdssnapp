...
class CertificationRequestSubmittedMail extends Mailable
{
    ...
    {
        return new Envelope(
            subject: 'Certification Request Submitted',
        );
    }
    ...
    {
        info('Sending email to user about certification request submitted: ' . $this->certificationRequest->id);
        ...
        return new Content(
            view: 'mail.certification-request-submitted-mail',
            with: [
